export type Role = "Admin" | "Developer" | "DepartmentUser";
export type ProjectStatus = "Planning" | "Working" | "Overdue" | "Finished" | "Submitted" | "Rejected";
...
export const MOCK_USERS: User[] = [
  ...
  { id: 7, fullName: "Aisha Nwosu", email: "aisha.nwosu@herocrm.com", role: "DepartmentUser", avatar: "AN", isActive: true, createdAt: "2025-07-01" },
...
export const MOCK_PROJECTS: Project[] = [
  ...
  { id: 6, name: "Quantum Analytics Data Pipeline", description: "ETL pipeline and warehousing solution for large-scale analytics ingestion.", status: "Submitted", priority: "Medium", startDate: "", dueDate: "2026-11-30", ownerId: 0, ownerName: "", customerId: 6, customerName: "Quantum Analytics", requestingDepartment: "Data Science", missedDeadlineReason: null, reasonCategory: null, progress: 0, requestedBy: "Aisha Nwosu", businessJustification: "Reduce data latency by 80% to enable real-time decision making." },
  { id: 7, name: "SkyBridge Fleet Tracker", description: "GPS-integrated fleet management and route optimization system.", status: "Submitted", priority: "High", startDate: "", dueDate: "2026-10-01", ownerId: 0, ownerName: "", customerId: 3, customerName: "SkyBridge Logistics", requestingDepartment: "Operations", missedDeadlineReason: null, reasonCategory: null, progress: 0, requestedBy: "Aisha Nwosu", businessJustification: "Cut fuel costs by 20% through optimized routing." },
...
export const MOCK_TASKS: Task[] = [
  ...
  { id: 3, title: "Build rate limiting service", description: "Per-client API rate limiting with configurable thresholds and Redis backing.", status: "InProgress", priority: "High", projectId: 2, projectName: "NovaTech API Gateway", assignees: [{ id: 3, name: "Priya Mehta", avatar: "PM" }, { id: 6, name: "David Park", avatar: "DP" }], createdById: 1, dueDate: "2026-09-20", createdAt: "2026-08-01" },
  { id: 4, title: "Responsive mobile layout", description: "Ensure all portal views are fully responsive down to 375px viewport.", status: "InProgress", priority: "Medium", projectId: 1, projectName: "Apex CRM Portal Redesign", assignees: [{ id: 2, name: "James Okafor", avatar: "JO" }], createdById: 1, dueDate: "2026-09-25", createdAt: "2026-08-15" },
  ...
  { id: 6, title: "Onboarding email triggers", description: "Automated email sequence for new hire steps with configurable delays.", status: "Todo", priority: "Medium", projectId: 3, projectName: "HR Onboarding Automation", assignees: [{ id: 4, name: "Lucas Rivera", avatar: "LR" }], createdById: 1, dueDate: "2026-09-15", createdAt: "2026-08-05" },
  { id: 7, title: "API gateway load testing", description: "Run k6 load tests up to 10k concurrent requests and document results.", status: "Todo", priority: "Urgent", projectId: 2, projectName: "NovaTech API Gateway", assignees: [{ id: 8, name: "Marco Ferretti", avatar: "MF" }], createdById: 1, dueDate: "2026-09-28", createdAt: "2026-09-01" },
  { id: 8, title: "EU GDPR compliance audit", description: "Full review of data processing flows against GDPR Article 30 requirements.", status: "Todo", priority: "High", projectId: 5, projectName: "EuroRetail Market Expansion", assignees: [{ id: 6, name: "David Park", avatar: "DP" }], createdById: 1, dueDate: "2026-10-10", createdAt: "2026-09-10" },
  { id: 9, title: "Customer portal SSO integration", description: "SAML 2.0 SSO with Apex's existing identity provider.", status: "InProgress", priority: "Urgent", projectId: 1, projectName: "Apex CRM Portal Redesign", assignees: [{ id: 2, name: "James Okafor", avatar: "JO" }, { id: 3, name: "Priya Mehta", avatar: "PM" }], createdById: 1, dueDate: "2026-10-01", createdAt: "2026-08-20" },
...
export const MOCK_SUBTASKS: SubTask[] = [
  ...
  { id: 7, taskId: 3, title: "Add per-route override config", isCompleted: false },
];

export const MOCK_COMMENTS: Comment[] = [
  { id: 1, taskId: 4, authorId: 1, authorName: "Sarah Chen", authorAvatar: "SC", content: "Let's prioritize tablet breakpoints first since most users are on iPads.", createdAt: "2026-08-16T09:22:00Z" },
  { id: 2, taskId: 4, authorId: 2, authorName: "James Okafor", authorAvatar: "JO", content: "Agreed. I'll start with the dashboard grid collapse. Should be done by EOD.", createdAt: "2026-08-16T10:45:00Z" },
  { id: 3, taskId: 3, authorId: 3, authorName: "Priya Mehta", authorAvatar: "PM", content: "Redis cluster is provisioned in staging. Starting implementation now.", createdAt: "2026-09-02T14:10:00Z" },
];
...
export const REPORTS_DATA = {
  ...
  taskStatus: [{ name: "Completed", count: 3 }, { name: "InProgress", count: 3 }, { name: "Review", count: 1 }, { name: "Todo", count: 3 }],
