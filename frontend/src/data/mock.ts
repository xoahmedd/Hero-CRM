...
export const MOCK_PROJECTS: Project[] = [
  { id: 1, name: "Apex CRM Portal Redesign", description: "Full redesign of the customer portal with new UX patterns and mobile responsiveness.", status: "In Progress", priority: "High", startDate: "2026-07-01", dueDate: "2026-10-15", ownerId: 2, ownerName: "James Okafor", requestingDepartment: "IT", missedDeadlineReason: null, reasonCategory: null, progress: 62, createdAt: "2026-07-01T08:00:00Z" },
  { id: 2, name: "NovaTech API Gateway", description: "Build and deploy a unified API gateway for NovaTech microservices architecture.", status: "In Progress", priority: "Urgent", startDate: "2026-06-15", dueDate: "2026-09-30", ownerId: 3, ownerName: "Priya Mehta", requestingDepartment: "Engineering", missedDeadlineReason: null, reasonCategory: null, progress: 78, createdAt: "2026-06-15T09:00:00Z" },
  { id: 3, name: "HR Onboarding Automation", description: "Automated onboarding workflow platform for new hire documentation and approvals.", status: "In Progress", priority: "Medium", startDate: "2026-05-01", dueDate: "2026-08-31", ownerId: 4, ownerName: "Lucas Rivera", requestingDepartment: "Human Resources", missedDeadlineReason: "Resource Constraints", reasonCategory: "Resource Constraints", progress: 45, createdAt: "2026-05-01T10:00:00Z" },
  { id: 4, name: "Meridian Compliance Dashboard", description: "Real-time compliance monitoring and reporting dashboard for financial regulations.", status: "Finished", priority: "High", startDate: "2026-03-01", dueDate: "2026-07-15", ownerId: 2, ownerName: "James Okafor", requestingDepartment: "Legal", missedDeadlineReason: null, reasonCategory: null, progress: 100, createdAt: "2026-03-01T11:00:00Z" },
  { id: 5, name: "EuroRetail Market Expansion", description: "Platform localization and EU compliance for 3 new regional market launches.", status: "In Progress", priority: "High", startDate: "2026-09-20", dueDate: "2026-12-31", ownerId: 6, ownerName: "David Park", requestingDepartment: "Sales", missedDeadlineReason: null, reasonCategory: null, progress: 8, createdAt: "2026-09-20T12:00:00Z" },
  { id: 6, name: "Quantum Analytics Data Pipeline", description: "ETL pipeline and warehousing solution for large-scale analytics ingestion.", status: "In Progress", priority: "Medium", startDate: "2026-10-01", dueDate: "2026-11-30", ownerId: 6, ownerName: "David Park", requestingDepartment: "Data Science", missedDeadlineReason: null, reasonCategory: null, progress: 15, createdAt: "2026-10-01T13:00:00Z" },
  { id: 7, name: "SkyBridge Fleet Tracker", description: "GPS-integrated fleet management and route optimization system.", status: "Cancelled", priority: "High", startDate: "2026-09-01", dueDate: "2026-10-01", ownerId: 4, ownerName: "Lucas Rivera", requestingDepartment: "Operations", missedDeadlineReason: null, reasonCategory: null, progress: 20, createdAt: "2026-09-01T14:00:00Z" },
  { id: 8, name: "Internal Knowledge Base", description: "Wiki-style internal knowledge base with search, versioning, and access control.", status: "Finished", priority: "Low", startDate: "2026-02-01", dueDate: "2026-06-30", ownerId: 8, ownerName: "Marco Ferretti", requestingDepartment: "IT", missedDeadlineReason: null, reasonCategory: null, progress: 100, createdAt: "2026-02-01T15:00:00Z" },
];
